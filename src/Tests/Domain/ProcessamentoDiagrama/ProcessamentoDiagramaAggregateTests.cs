...
public class ProcessamentoDiagramaAggregateTests
{
    ...
    public void Criar_DeveCriarComSucesso_QuandoAnaliseDiagramaIdValido()
    {
        ...
        // Assert
        processamento.Id.ShouldNotBe(Guid.Empty);
        processamento.AnaliseDiagramaId.ShouldBe(analiseDiagramaId);
        processamento.DeveEstarComStatus(StatusProcessamentoEnum.AguardandoProcessamento);
        processamento.TentativasProcessamento.Valor.ShouldBe(0);
        processamento.NaoDeveConterAnaliseResultado();
        processamento.HistoricoTemporal.DataCriacao.ShouldNotBe(default);
    }
    ...
    public void IniciarProcessamento_DeveMudarStatus_QuandoAguardando()
    {
        ...
        processamento.HistoricoTemporal.DataInicioProcessamento.ShouldNotBeNull();
    }
    ...
    public void ConcluirProcessamento_DeveConcluir_QuandoStatusEmProcessamento()
    {
        ...
        // Assert
        processamento.DeveEstarComStatus(StatusProcessamentoEnum.Concluido);
        processamento.DeveConterAnaliseResultado();
        processamento.TentativasProcessamento.Valor.ShouldBe(2);
        processamento.HistoricoTemporal.DataConclusaoProcessamento.ShouldNotBeNull();
    }
    ...
    public void RegistrarFalha_DeveRegistrar_QuandoStatusEmProcessamento()
    {
        ...
        // Assert
        processamento.DeveEstarComStatus(StatusProcessamentoEnum.Falha);
        processamento.TentativasProcessamento.Valor.ShouldBe(3);
        processamento.NaoDeveConterAnaliseResultado();
        processamento.HistoricoTemporal.DataConclusaoProcessamento.ShouldNotBeNull();
    }
