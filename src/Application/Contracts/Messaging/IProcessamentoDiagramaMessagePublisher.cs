...
public interface IProcessamentoDiagramaMessagePublisher
{
    ...
    Task PublicarProcessamentoErroAsync(Domain.ProcessamentoDiagrama.Aggregates.ProcessamentoDiagrama processamentoDiagrama, string motivo, string? origemErro = null);
}
